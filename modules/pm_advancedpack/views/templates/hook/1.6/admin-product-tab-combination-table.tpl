				{foreach from=$packProduct['productCombinations'] item='productCombination'}
					...
					{/if}
				<tr id="ap5_combination-{$idProductPack}-{$ap5_idProductAttribute}" class="nodrag nodrop{if $ap5_isDefaultCombination} highlighted{/if}">
					...
					<td class="ap5_discountCell{if !isset($hasDiscountOnCombinations[$idProductPackKey]) || !$hasDiscountOnCombinations[$idProductPackKey]} ap5_inputDisabled{/if}" data-id-product-pack="{$idProductPack}">
						<input min="0" class="ap5_reductionAmount" type="text" required="required" onchange="this.value = this.value.replace(/,/g, '.');" value="{if $ap5_combinationReductionType == 'percentage'}{toolsConvertPrice price=$ap5_combinationReductionAmount*100}{else}{toolsConvertPrice price=$ap5_combinationReductionAmount}{/if}" size="2" id="ap5_combinationReductionAmount-{$idProductPack|escape:'html':'UTF-8'}-{$ap5_idProductAttribute}" name="ap5_combinationReductionAmount-{$idProductPack|escape:'html':'UTF-8'}-{$ap5_idProductAttribute}" maxlength="14" /><select class="ap5_combinationReductionType" name="ap5_combinationReductionType-{$idProductPack|escape:'html':'UTF-8'}-{$ap5_idProductAttribute}" id="ap5_combinationReductionType-{$idProductPack|escape:'html':'UTF-8'}-{$ap5_idProductAttribute}">
