...
class ImageWorkshopLib
{
    ...
    public static function getTextBoxDimension($fontSize, $fontAngle, $fontFile, $text)
    {
        if (!file_exists($fontFile)) {
            throw new ImageWorkshopLibException('Can\'t find a font file at this path : "' . $fontFile . '".',
     ...
     */
    public static function mergeTwoImages(
        &$destinationImage,
        $sourceImage,
        $destinationPosX = 0,
        $destinationPosY = 0,
        ...
        imageCopy($destinationImage, $sourceImage, $destinationPosX, $destinationPosY, $sourcePosX, $sourcePosY,
