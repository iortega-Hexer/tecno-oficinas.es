...
class mib extends Module
{
        ...
        if ($form == 1) {
            ...
            if (defined('_PS_ADMIN_DIR_')) {
                ...
                if (Configuration::get('mypresta_updates') != 0 || (bool)Configuration::get('mypresta_updates') != false) {
                    ...
                    if (mibUpdate::version($this->version) < mibUpdate::version(Configuration::get('updatev_' . $this->name)) && Tools::getValue('ajax', 'false') == 'false') {
    ...
    function install()
    {
        if ($this->psversion() == 7) {
            if (parent::install() == false OR !
                ...
                !$this->registerHook('displayFooterBefore') OR
    ...
    public function hookFooterBefore($params)
    {
        if (Configuration::get('MIB_WHERE') == 'displayFooterBefore') {
            return $this->buildManufacturersList($params);
        }
    }
                        ...
                        'options' => array(
                            'query' => array(
                                ...
                                array(
                                    ...
                                    'name' => $this->l('Footer before') . ' (displayFooterBefore)',
                                ),
                                array(
                                    'id'   => 'displayTop',
